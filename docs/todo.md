...
- [x] **2026-07-31** — pitwall-companion: added a Boosts scope to Tools →
      ...
      two scopes. Pushed directly to `claude/repo-update-check-mn1wv2` (not
      yet opened as a PR). Not its own queue item for the same reason as
      the entries below. See `docs/session-log.md` for full detail.
