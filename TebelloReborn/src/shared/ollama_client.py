...
def call_ollama(
    ...
    than hanging or silently falling back to another backend (ADR-003 §2)."""
    ...
    try:
        ...
        # it just didn't finish generating within READ_TIMEOUT. Distinct
        # failure mode from "Ollama isn't running"; must not share that
        # message (ADR-003 §2).
        raise OllamaError(
