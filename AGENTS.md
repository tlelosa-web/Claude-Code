...
Lives in `.Codex/agents/`. Each executor is domain-aware by design.
...
| `ai-architect` | `agents/ai-architect.md` | Software/AI | Agentic workflows, AGENTS.md, system design |
...
file_read:
  ...
  - Read AGENTS.md at session start — always
...
Codex --worktree trading-indicator
Codex --worktree engineering-calc
Codex --worktree ui-dashboard
