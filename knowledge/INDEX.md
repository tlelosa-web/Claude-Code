...
|------|--------|---------------|
| `tlelosa-claude-config.md` | The private Claude Code plugin marketplace repo: structure, machine split (Operations/Pappa T), IT clearance status, open rollout items, CORE.md version | 2026-07-28 |
