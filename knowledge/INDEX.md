...
| `pappa-t.md` | Pappa T (personal machine): what it is vs. Operations, no live remote-environment bridge (git sync only), Pappa T-only items (codex-gate), TebelloReborn/Career Engine project (stack, MVP status, open items) | 2026-07-28 |
