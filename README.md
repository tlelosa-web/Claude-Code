...
│   ├── motor_fla_lookup.py              # FLA lookup from PDF
│   ├── connection_lookup.py             # Connection type determination
│   ├── excel_source.py                  # Excel data handling
│   └── 2025 - CTP 022- PB4  Performance Data Rev 0.pdf  # Motor specs
├── frontend/
│   ├── src/
...
```bash
pip install fastapi uvicorn pydantic reportlab pdfplumber
```
