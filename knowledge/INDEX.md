...
| `pappa-t.md` | Pappa T (personal machine): what it is vs. Operations, no live remote-environment bridge (git sync only), Pappa T-only items (codex-gate), 2026-07-28 vault survey findings; stale duplicate hub clone removed 2026-08-06 (corrects that survey's gitlink call), vault repo still has no remote | 2026-08-06 |
